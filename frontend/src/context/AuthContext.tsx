...
//   };
  ...
  const signInWithTwitter = async (): Promise<void> => {
    try {
      ...
      // Optionally send ID token to backend
      // await sendAuthRequestToBackend("https://your-backend-url", idToken);
  ...
  return (
    <AuthContext.Provider value={{ user, loading, signUp, signIn, signInWithGoogle, signInWithTwitter, fetchUserProfile, signOut }}>
      {!loading && children}
