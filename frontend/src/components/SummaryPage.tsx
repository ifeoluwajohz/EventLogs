      ...
      <div className="p-8 bg-white shadow-lg rounded-md text-center w-full max-w-md">
        ...
        <div className="flex justify-between">
          <button
            ...
            className="py-2 px-4 bg-gray-600 text-black rounded-md hover:bg-gray-700 transition"
          >
            Go Back
          </button>
          <button
            onClick={handleSubmit}
            className="py-2 px-4 bg-green-600 text-black rounded-md hover:bg-green-700 transition"
          >
            Submit
          </button>
        </div>
